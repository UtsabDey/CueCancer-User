...
<div class="col-md-7 col-lg-8 col-xl-9">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ url('patient/profile/update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row form-row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <label>User ID</label>
                            <input type="text" name="patient_id" class="form-control" value="{{ $user->patient_id }}" readonly>@error('patient_id')<small class="text-danger">{{ $message }}</small>@enderror
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
